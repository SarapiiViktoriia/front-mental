...
a.name="Invariant Violation"}a.framesToPop=1;throw a;}}function t(a){for(var b=arguments.length-1,d="https:
...
c&&(d+=a.substring(m,c));m=c+1;d+=b}a=m!==c?d+a.substring(m,c):d}return a}function V(a){switch(a){case "svg":return"http:
...
a.replace(F,G);n[b]=new p(b,1,!1,a,null)});"xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(a){var b=a.replace(F,G);n[b]=new p(b,1,!1,a,"http:
...
null==b?b:typeof b,"")};a.prototype.renderDOM=function(a,d,c){var b=a.type.toLowerCase();"http:
